...
public class AddExecutor
{
    ...
    /// Delegates to ProfileIdHelper.NormalizeProfileId.
    /// </summary>
    internal static string NormalizeProfileId(string profileId) => ProfileIdHelper.NormalizeProfileId(profileId);
